const toolDeclarations = [
    ...
    },
    {
        ...
        description: 'Read cart subtotal, shipping (tiered by cart subtotal from store settings), and grand total from the browser cart. Use only when the user asks for totals — not after add_to_cart (that response already includes totals).'
    },
